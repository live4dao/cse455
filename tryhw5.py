...
print("loading data...")
train = load_classification_data("mnist.train".encode('utf-8'), "mnist.labels".encode('utf-8'), 1)
test  = load_classification_data("mnist.test".encode('utf-8'), "mnist.labels".encode('utf-8'), 1)
print("done")
print
